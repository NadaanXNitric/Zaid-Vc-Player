...
MONGO_DB_URL = getenv("MONGO_DB_URL", "mongodb+srv://Rone:rone@cluster0.sln9j.mongodb.net/myFirstDatabase?retryWrites=true&w=majority")
OWNER_NAME = getenv("OWNER_NAME", "Nikhil")
OWNER_USERNAME = getenv("OWNER_USERNAME", "XeD_Nik")
ALIVE_NAME = getenv("ALIVE_NAME", "Nik")
BOT_USERNAME = getenv("BOT_USERNAME", "NaughtyHottyBot")
OWNER_ID = getenv("OWNER_ID", "5382693429")
ASSISTANT_NAME = getenv("ASSISTANT_NAME", "NaughtyHottyy")
GROUP_SUPPORT = getenv("GROUP_SUPPORT", "BotDemons")
UPDATES_CHANNEL = getenv("UPDATES_CHANNEL", "Bot_Demons")
HEROKU_APP_NAME = getenv("HEROKU_APP_NAME")
HEROKU_API_KEY = getenv("UPDATES_CHANNEL", "HEROKU_API_KEY")
SUDO_USERS = list(map(int, getenv("SUDO_USERS", "5382693429").split()))
COMMAND_PREFIXES = list(getenv("COMMAND_PREFIXES", "/ ! .").split())
ALIVE_IMG = getenv("ALIVE_IMG", "https://telegra.ph/file/fc9d87ffd1c6f828eb7fc.png")
START_PIC = getenv("START_PIC", "https://telegra.ph/file/a414e2cdfeaa7d4414b89.png")
DURATION_LIMIT = int(getenv("DURATION_LIMIT", "2400"))
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/NadaanXNitric/Zaid-Vc-Player")
